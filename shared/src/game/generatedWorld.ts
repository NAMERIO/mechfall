...
/** This file is replaced by the map maker's ADD TO GAME button. */
...
export const GENERATED_WORLD_MODEL: WorldModel | undefined = undefined;
...
export const GENERATED_WORLD_HULLS: readonly WorldHull[] = [] as const;
